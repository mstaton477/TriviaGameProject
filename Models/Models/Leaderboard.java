...
public class Leaderboard {
        ...
        public List<Integer> get_scoreColumn() { return this._scoreColumn; }

        public List<String> get_categoryColumn() { return this._categoryColumn; }

        public List<String> get_difficultyColumn() { return this._difficultyColumn; }

        public List<Integer> get_lengthColumn() { return this._lengthColumn; }

        public List<Timestamp> get_datePlayedColumn() { return this._datePlayedColumn; }


        // ================================ SETTERS ====================================


        public void set_nameColumn(List<String> _nameColumn) { this._nameColumn = _nameColumn; }

        public void set_scoreColumn(List<Integer> _scoreColumn) { this._scoreColumn = _scoreColumn; }

        public void set_categoryColumn(List<String> _categoryColumn) { this._categoryColumn = _categoryColumn; }

        public void set_difficultyColumn(List<String> _difficultyColumn) { this._difficultyColumn = _difficultyColumn; }

        public void set_lengthColumn(List<Integer> _lengthColumn) { this._lengthColumn = _lengthColumn; }

        public void set_datePlayedColumn(List<Timestamp> _datePlayedColumn) { this._datePlayedColumn = _datePlayedColumn; }
}
